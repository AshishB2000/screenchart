...
function setHubTitleBarOverlay(win, effective) {
...
function fitToWorkArea(workArea, preferredWidth) {
...
module.exports = { createHubWindow, setHubTitleBarOverlay };

...
module.exports = { resolveUserPath, loginShellPath, knownDirs, nvmBinDirs };

// Self-check: `node src/userPath.js`. Simulates a stripped Finder PATH and
// asserts resolveUserPath recovers real user bin dirs.
